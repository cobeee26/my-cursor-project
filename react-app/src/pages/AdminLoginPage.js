...
const AdminLoginPage = () => {
  ...
  useEffect(() => {
    const isAuthenticated = localStorage.getItem('plmun_admin_authenticated');
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      ...
      localStorage.setItem('plmun_admin_authenticated', 'true');
      localStorage.setItem('plmun_admin_number', formData.adminNumber);
    }, 1500);
  };
        ...
        >
            ...
            {!isLoggedIn ? (
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  {/* Admin Number Field */}
                  <div>
                    <label htmlFor="adminNumber" className="block text-white text-sm font-medium mb-2">
                      Admin Number
                    </label>
              ...
              >
                ...
                <p className="text-gray-300 mb-8">
                  Welcome to PLMun Admin Portal. You can now access your admin dashboard.
                </p>
          ...
          <div className="text-center mt-8">
            <p className="text-gray-400 text-sm">
              © 2024 Pamantasan ng Lungsod ng Muntinlupa - Admin Portal
            </p>
          </div>
        </motion.div>
      </div>
